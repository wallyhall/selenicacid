...
class Cli_HttpServer
{
    ...
    public static function start($user=null, $daemon=false)
    {
    ...
    private static function forkServer($user)
    {
    }

    private static function forkRequest($conn)
    {
        $fork = -1;
        $childPid = "";
        if (PCNTL_ENABLED) {
    ...
    private static function openPort()
    {
